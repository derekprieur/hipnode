        ...
        <Link href={`/meetups`}>
            <div className='flex gap-[14px] items-start'>
                ...
                <div className='flex flex-col'>
                    <h1 className='text-textLight1 dark:text-textDark1 font-semibold text-[14px]'>{meetup.title}</h1>
                    ...
                    <div className='flex gap-[10px] mt-[10px]'>
                        {meetup.tags.map((tag, index) => (
                            <div className='bg-backgroundLight3 dark:bg-backgroundDark3 py-[2px] px-2 rounded-[20px] text-textLight2 text-[9px]' key={index}>{tag}</div>
                        ))}
                    </div>
                </div>
            </div>
