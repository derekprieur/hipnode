...
const Signup = () => {
    return (
        <div className='bg-backgroundDark1 h-full pt-8 px-6'>
            <Image src={'/assets/logo.png'} width={146} height={38} alt='logo' className='mb-[60px]' />
            ...
            <input type="text" placeholder='e.g. Hipnode123' className='bg-backgroundDark2 py-3 px-5 rounded-lg w-full text-sm mt-[10px]' />
            <button className='bg-backgroundAlt1 text-textLight1 py-[10px] px-10 rounded-lg mt-5 text-lg font-semibold'>Next</button>
            <p className='text-textLight1 mt-5 text-sm mb-[30px]'>Already have an account? <span className='text-textAlt1 font-semibold'>Sign in.</span></p>
